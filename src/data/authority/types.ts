...
export type CitationVerificationState =
  'unverified' | 'partially-verified' | 'verified' | 'unresolved';
export type AuthorityClaimStrength =
  'background' | 'contextual' | 'partial' | 'direct';
...
export interface CitationRecord {
  ...
  claimStrength: AuthorityClaimStrength;
