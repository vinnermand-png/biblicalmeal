  ...
  return (
    <div className="bm-mobile-menu lg:hidden">
      ...
      >
        ...
        <span className="bm-mobile-menu__icon" aria-hidden="true"><i></i><i></i></span>
      </button>

      {open && (
        <nav ref={menuRef} id="mobile-nav" aria-label="Mobile navigation" role="dialog" aria-modal="true" className="bm-mobile-menu__panel">
          <div className="bm-mobile-menu__topline">
            <div className="bm-mobile-menu__eyebrow">BiblicalMeal</div>
            <button type="button" onClick={() => setOpen(false)} className="bm-mobile-menu__close" aria-label="Close menu">Close <span aria-hidden="true">×</span></button>
          </div>
      ...
      <style>{`
        ...
        .bm-mobile-menu__icon{display:grid;gap:4px;width:1.2rem}.bm-mobile-menu__icon i{display:block;width:100%;height:1px;background:currentColor}
        ...
        .bm-mobile-menu__topline{display:flex;align-items:center;justify-content:space-between;padding-bottom:1.4rem;border-bottom:1px solid rgba(201,167,106,.22)}
        .bm-mobile-menu__eyebrow{color:#c9a76a;font-family:var(--font-sans,Arial,sans-serif);font-size:.58rem;font-weight:700;letter-spacing:.22em;text-transform:uppercase}
        .bm-mobile-menu__close{display:inline-flex;align-items:center;gap:.55rem;border:0;background:transparent;color:#f1e8d9;font-family:var(--font-sans,Arial,sans-serif);font-size:.55rem;font-weight:700;letter-spacing:.16em;text-transform:uppercase}.bm-mobile-menu__close span{font-family:Arial,sans-serif;font-size:1.25rem;font-weight:300;line-height:1}
        .bm-mobile-menu__links{margin:2.2rem 0 2rem;padding:0;list-style:none}.bm-mobile-menu__links li{border-bottom:1px solid rgba(244,238,224,.12)}
        .bm-mobile-menu__links a{display:grid;grid-template-columns:2.25rem 1fr auto;align-items:center;gap:.5rem;padding:1.1rem 0;color:#f2ebdf;font-family:var(--font-display,Georgia,serif);font-size:clamp(1.65rem,7vw,2.25rem);line-height:1.05;text-decoration:none}.bm-mobile-menu__links a span{color:#a98651;font-family:var(--font-sans,Arial,sans-serif);font-size:.55rem;font-weight:700;letter-spacing:.12em}.bm-mobile-menu__links a b{color:#c49a57;font-family:var(--font-sans,Arial,sans-serif);font-size:1rem;font-weight:400}
